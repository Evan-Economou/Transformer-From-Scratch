...
## Analysis of Results
All three of the trained models had much lower loss than the untrained model and produce signifigantly more coherent text. Another thing of note is that each of the 3 trained models had very similar loss, despite two of them utilizing positional embedding. This could be because the model may have implicitely learned positional data, or that in our trainng data, position isn't that important as it is a collection of small speeches. Either way, The example outputs for both of the positionally embedded models appear more cohesive for the most part. 
